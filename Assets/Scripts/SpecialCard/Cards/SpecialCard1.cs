...
public class SpecialCard1 : SpecialCard
{
    ...
    void Start()
    {
        ...
        if (m_UsedPlayerID == 1)
        {
            m_ArrowObj = GameObject.Instantiate(Resources.Load("SpecialWeapon/SpecialArrow/SpecialArrow1")) as GameObject;
            m_arrowPosX = MyUtility.SOLDIER_CREATE_LINE_X_1P - 8.0f;
        }
        else
        {
            m_ArrowObj = GameObject.Instantiate(Resources.Load("SpecialWeapon/SpecialArrow/SpecialArrow2")) as GameObject;
