...
public class GameUIManager : MonoBehaviour {
    ...
    void Awake()
    {
       ...
       //戦力ゲージ作成スクリプト
        ...
        //      //タイムUIを作成
            obj = MyUtility.CreateImage(
                "TimeImage",
                "Image/TimeWaku",
                new Vector2(1.0f / 32.0f, 0.0f / 25.0f),
                new Vector2(4.0f / 32.0f, 4.0f / 25.0f),
          canvasTransForm);

            obj = MyUtility.CreateImage(
                   "TimeImage2",
                "Image/TimeWaku",
                new Vector2(28.0f / 32.0f, 21.0f / 25.0f),
                new Vector2(31.0f / 32.0f, 25.0f / 25.0f),
          canvasTransForm);
      ...
      canvasTransForm,
            45,
            new Vector3(0, 0, -90),
            new Vector2(1.0f / 32.0f, 2.0f / 25.0f),
            new Vector2(3.0f / 32.0f, 3.0f / 25.0f)
            );
     ...
     canvasTransForm,
           45,
           new Vector3(0, 0, 90),
            new Vector2(29.0f / 32.0f, 22.0f / 25.0f),
            new Vector2(31.0f / 32.0f, 25.0f / 25.0f)
           );
        ...
        obj = MyUtility.CreateButton(
            "SpecialCardButton",
            "Image/TimeWaku",
            new Vector2(1.0f / 32.0f,  4.0f / 25.0f),
            new Vector2(4.0f / 32.0f, 13.0f / 25.0f),
            canvasTransForm
            );
        ...
        obj = MyUtility.CreateButton(
            "SpecialCardButton",
            "Image/TimeWaku",
            new Vector2(28.0f / 32.0f, 12.0f / 25.0f),
            new Vector2(31.0f / 32.0f, 21.0f / 25.0f),
            canvasTransForm
            );
        ...
        for (int i = 1; i <= 5; i++)
        {
            for (int j = 1; j <= 2; j++)
            {
                obj = MyUtility.CreateButton(
                    "SoldierButton",
                    "Image/sword_I",
                    new Vector2((5.0f + 20.0f * (j - 1)) / 32.0f, (20.0f - 5.0f * (i - 1)) / 25.0f),
                    new Vector2((7.0f + 20.0f * (j - 1)) / 32.0f, (25.0f - 5.0f * (i - 1)) / 25.0f),
                    canvasTransForm);
        ...
        for (int i = 1; i <= 5; i++)
        {
            for (int j = 1; j <= 2; j++)
            {
                obj = MyUtility.CreateImage(
                    ...
                    new Vector2((4 + 23.0f * (j - 1)) / 32.0f,  (20.0f - (5.0f * (i - 1))) / 25.0f),
                     new Vector2((5 + 23.0f * (j - 1)) / 32.0f, (25.0f - (5.0f * (i - 1))) / 25.0f),
                     canvasTransForm
                    );
