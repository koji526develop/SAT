...
public class MyUtility : MonoBehaviour
{
    ...
    static Vector2 GetCenterPositionOfUI(RectTransform _rect, Vector2 _maxScale)
    {
        Vector2 vec2;
        vec2.x = _rect.anchorMax.x * Screen.width - _maxScale.x / 2;
        vec2.y = _rect.anchorMax.y * Screen.height - _maxScale.y / 2;
